...
from chrispnet.modules.encoder.layer.conformer_layer import ConformerLayer
from chrispnet.modules.encoder.prenet.subsampling import ConvSubsampling
...
class ConformerEncoder(torch.nn.Module):
    ...
    def forward_for_export(self, audio_signal, length):
        ...
        # audio_signal = torch.transpose(audio_signal, 1, 2)
        # print(audio_signal.shape, length)
...
if __name__ == "__main__":
    ...
    audio_signal = torch.randn(2, 80, 1600)
    ilens = torch.tensor([1400, 1600])  # .to(xs.device)

    audio_signal = torch.transpose(audio_signal, 1, 2)
    res = model.forward(audio_signal, ilens)
